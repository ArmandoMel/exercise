...
public class ProfitToolApp2 {

	private final static Logger logger = Logger.getLogger(ProfitToolApp2.class);
	...
	public void process() throws ApplicationException {
		...
		TreeMap<String, TotalProfit> totalNProfitsByRegionMap = calculateTotalNetProfitByRegion(accountsList);

		TreeMap<String, TotalProfit> totalGProfitsByCountryMap = calculateTotalGrossProfitByCountry(accountsList);

		TreeMap<String, TotalProfit> totalGProfitsByRegionMap = calculateTotalGrossProfitByRegion(accountsList);
